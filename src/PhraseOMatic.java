public class PhraseOMatic {
    public static void main(String[] args){
        ...
        String[] wordListOne = {
                ...
                "reactive", "agent based", "functional", "Ai enabled", "strong typed"
        };
        String[] wordListTwo = {
                "loosely coupled", "event driven", "pub-sub", "IoT", "cloud", "native", "native",
                "service oriented", "containerized", "serverless", "microservices", "distributed leger"
        };
